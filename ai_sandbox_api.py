...
def init_db():
    ...
    # Cleanly reset crunch_tasks table for local development schema alignment
...
# Initialize tables immediately upon loading
init_db()
    ...
    <html>
        <head>
            ...
            <style>
                ...
                h1 { color: #38bdf8; }
                h2 { color: #38bdf8; border-bottom: 1px solid #334155; padding-bottom: 5px; margin-top: 30px; }
